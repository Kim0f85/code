...
public class SignUp {
	public static void signUp() {
		 ...
		 * 
		 * 
		 * //----------------pw---------------- String pw1,pw2; do { do {
		 * System.out.printf("\n%22s(10~16자리 영문과 숫자 조합)\n"," ");
		 * System.out.printf("%22s2.비밀번호: "," "); pw1 = scan.nextLine(); }
		 * while(!DataBase.validPw(pw1));
		 * 
		 * System.out.printf("\n%22s3.비밀번호 재확인: "," "); pw2 = scan.nextLine();
		 * 
		 * //DataBase.user pw 추가 if (pw1.equals(pw2)) { HashMap<String, String> newUser
		 * = new HashMap<String, String>();
		 * 
		 * String finPw = Encrypt.encrypt(pw2); //pw 암호화
		 * 
		 * newUser.put("비밀번호", finPw); // 유효한 비밀번호를 HashMap에 저장
		 * DataBase.setUser(newUser); // HashMap을 ArrayList에 추가 break; } else {
		 * System.out.printf("\n%22s비밀번호가 다릅니다.\n\n", " "); }
		 * 
