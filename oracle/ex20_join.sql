...
insert into tblStaff (seq, name, salary, address, project)
    values (5, '호호호', 250, '서울시', '회원 응대, 게시판 관리');    
...
-- ORA-02291: 무결성 제약조건(HR.SYS_C008671)이 위배되었습니다- 부모 키가 없습니다
insert into tblProject (seq, project, staff_seq)
    values (7, '고객 유치', 5);
...
-- ORA-02292: 무결성 제약조건(HR.SYS_C008671)이 위배되었습니다
-- - 자식 레코드가 발견되었습니다
